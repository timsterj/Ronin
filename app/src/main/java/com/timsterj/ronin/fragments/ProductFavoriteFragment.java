...
import com.timsterj.ronin.listeners.ISwipedItemFavoriteListener;
...
public class ProductFavoriteFragment extends MvpAppCompatFragment implements ProductFavoriteContract.View,
    ...
    public static ProductFavoriteFragment getNewInstance(String name) {
